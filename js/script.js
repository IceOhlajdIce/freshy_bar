...
const createCartItem = (item) => {
    ...
    li.innerHTML = `
        <img class="order_img" src="img/Frame__2.jpg" alt="${item.title}">
        ...
        <button class="order__item-delete" data-idls="${item.idls}" aria-label="Удалить коктель из корзины"></button>
